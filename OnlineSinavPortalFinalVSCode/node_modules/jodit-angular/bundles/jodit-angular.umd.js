(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global["jodit-angular"] = {}, global.ng.core, global.ng.forms, global.ng.common));
    ...
    ***************************************************************************** */
    ...
    var CUSTOM_INPUT_CONTROL_VALUE_ACCESSOR = {
        ...
        useExisting: core.forwardRef(function () { return JoditAngularComponent; }),
        multi: true
    };
    var JoditAngularComponent = /** @class */ (function (_super) {
        ...
        JoditAngularComponent.prototype.createElement = function () {
        ...
        JoditAngularComponent.prototype.resetEditor = function () {
            this.editor.destruct();
            this.createEditor();
        };
        JoditAngularComponent.prototype.ngAfterViewInit = function () {
            if (!this.element) {
                this.createElement();
                this.createEditor();
            }
        };
        JoditAngularComponent.prototype.createEditor = function () {
            var _this = this;
            ...
            this.editor.events
                ...
                if (typeof _this.onChangeCallback === 'function') {
                    _this.ngZone.run(function () { return _this.onChangeCallback(value); });
                }
            })
                .on('blur', function () {
                if (typeof _this.onTouchedCallback === 'function') {
                    _this.ngZone.run(function () { return _this.onTouchedCallback(); });
                }
            });
            validEvents.forEach(function (eventName) {
                ...
                if (eventEmitter.observers.length > 0) {
                    ...
                    _this.editor.events.on(eventNameInJodit, _this.ngZone.run(function () { return function () {
                        var args = [];
        ...
        JoditAngularComponent.prototype.ngOnDestroy = function () {
            if (this.editor) {
                this.editor.destruct();
            }
        };
        JoditAngularComponent.prototype.writeValue = function (v) {
            this.value = v;
        };
        JoditAngularComponent.prototype.registerOnChange = function (fn) {
            this.onChangeCallback = fn;
        };
        JoditAngularComponent.prototype.registerOnTouched = function (fn) {
            this.onTouchedCallback = fn;
        };
        JoditAngularComponent.prototype.setDisabledState = function (isDisabled) {
